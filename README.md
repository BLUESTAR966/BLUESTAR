<div class="hero-container">
  <div class="header-overlay">
    <p class="brand">EVERGREEN HERBS</p>
    <p class="brand">GROWING THE FUTURE</p>
    <div img=logo
...
{/* Hero Section */}
  ...
  <section id="products" className="p-10">
    ...
    <div className="grid md:grid-cols-3 gap-6">
      {["Chives", "Mint", "Rosemary", "Thyme", "Coriander", "Oregano"].map
